    ...
    <div class="container-fluid p-3 p-md-3">
        <div
            ...
            <div class="d-flex align-items-center gap-4 mt-4 mb-4">
                ...
                <div>
                    <h4 class="text-dark mb-0 fw-bold">Thêm nhân bánh</h4>
                    <small class="text-muted">Tạo nhân bánh mới</small>
                </div>
            </div>
        </div>
        ...
        <div class="card shadow-lg border-0 mb-4 animate__animated animate__fadeInUp">
            <div class="card-body p-4">
                <form method="POST" action="{{ route('nhanbanh.store') }}">
                    @csrf
                    <div class="row g-4">
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text"
                                    ...
                                    id="tenNhanBanh" name="tenNhanBanh" value="{{ old('tenNhanBanh') }}" required>
                                @error('tenNhanBanh')
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-end gap-2 mt-4">
                        ...
                        <button type="submit" class="btn btn-primary w-100 w-md-auto shadow-sm">
                            <i class="bi bi-save"></i> Thêm nhân bánh
                        </button>
                    </div>
                </form>
            </div>
