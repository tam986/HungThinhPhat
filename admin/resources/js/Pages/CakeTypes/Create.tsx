...
export default function CreateCakeType() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    post(route('loaibanh.store'));
  };

  return (
    <AdminLayout>
      <Head title="Thêm loại bánh mới" />
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-slate-900 text-dark">Thêm loại bánh</h1>
            <p className="text-slate-500 text-sm mt-1 font-medium">
               Thiết lập một loại bánh mới vào hệ thống.
            </p>
          </div>
        </div>
      </div>
           ...
           <div className="space-y-4">
              ...
              <div className="relative">
                <input 
                  ...
                  placeholder="VD: Bánh pía, Bánh in, Bánh trung thu..."
                  autoFocus
                />
                {errors.tenLoaiBanh && (
