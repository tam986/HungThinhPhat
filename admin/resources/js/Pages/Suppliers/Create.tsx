...
export default function CreateSupplier() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    post(route('nhacungcap.store'));
  };

  return (
    <AdminLayout>
      <Head title="Thêm Đại lý mới" />
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-slate-900 text-dark">Thêm Đại lý</h1>
            <p className="text-slate-500 text-sm mt-1 font-medium">
               Mở rộng mạng lưới đối tác cung ứng của bạn.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="bg-white p-8 rounded-[32px] border border-slate-200 shadow-sm text-dark space-y-6">
               <div className="space-y-2">
                  ...
                  <input 
                    ...
                    placeholder="VD: Cộng ty Thực phẩm ABC"
                  />
               ...
               <div className="space-y-4">
                  ...
                  {preview ? (
                    ...
                    >
                       ...
                       <p className="text-xs font-bold text-slate-400 uppercase tracking-wider">Chọn ảnh logo</p>
            ...
            <div className="bg-white p-6 rounded-[28px] border border-slate-200 shadow-sm text-dark sticky top-24">
               <div className="space-y-6">
                  ...
                  <div className="pt-6 border-t border-slate-50 space-y-3">
                     ...
                     >
                       <Save size={18} />
                       {processing ? 'Đang lưu...' : 'Lưu Đại lý'}
                     </button>
                     <Link 
                       href={route('nhacungcap.index')}
