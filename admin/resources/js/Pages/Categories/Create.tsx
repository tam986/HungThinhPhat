    ...
    <AdminLayout>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-slate-900 text-dark">Thêm danh mục mới</h1>
            <p className="text-slate-500 text-sm mt-1">
               Tạo phần loại mới cho kho hàng của bạn.
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="bg-white p-8 rounded-[32px] border border-slate-200 shadow-sm text-dark space-y-6">
               <div className="space-y-2">
                  ...
                  <input 
                    ...
                    placeholder="VD: Bình kem sữa tươi"
                  />
               ...
               <div className="space-y-2">
                  ...
                  <textarea 
                    ...
                    placeholder="Nhập mã tả ngắn gần về danh mục này..."
                  />
               </div>
